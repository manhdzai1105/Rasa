    ...
    async def run(self, dispatcher: CollectingDispatcher,
        ...
        if condition_name:
            ...
            if theuse:
                ...
                dispatcher.utter_message(response="utter_no_condition_theuse")
        else:
            dispatcher.utter_message(text="Vui lòng cung cấp tên câu điều kiện bạn cần biết cách sử dụng.")
